        ...
        <div className='footer-bar'>
          <div className='container'>
            <div className='row align-items-center justify-content-center'>
              <p>Powered by <a href='https://urhrp.csb.app/'>CodeSandbox</a>, <a href='https://www.saturn.network'>Saturn Network</a> and <a href='https://github.com/amisdex'>AmisDex</a></p>
            </div>
          </div>
        </div>
